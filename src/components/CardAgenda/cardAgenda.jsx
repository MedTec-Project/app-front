...
export default function CardAgenda({ id, isOn, toggle, isAnimating }) {
  return (
    <div className={`card-scheduling ${isOn ? "inactive-card" : ""} ${isAnimating ? "card-animating" : ""}`}>
      ...
      <div className="switch-container">
        <div className={`switch ${isOn ? "on" : "off"}`} onClick={toggle}
          ...
          <span className="txt" style={{
            color: isOn ? "#fcfcfc" : "#48735F",
            padding: "20px",
            marginLeft: isOn ? "-20px" : "20px",
            fontWeight: "800",
            fontSize: "11px",
            zIndex: isOn ? "-10" : "100"
          }}>
